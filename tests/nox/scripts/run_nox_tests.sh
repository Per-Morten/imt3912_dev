...
do
    ...
    ./run_test.sh --test-name="${compiler}_${nr}" --results-folder="$resultsRoot/memory_usage/empty_actors" --command="./build/bin/nox_empty_actors -actor_amount $i" --save-program-output=yes;
    ((i=i*2));
    ((count++));
done
...
do
    ...
    ./run_test.sh --test-name="${compiler}_${nr}" --results-folder="$resultsRoot/memory_usage/transform_actors" --command="./build/bin/nox_transform_actors -actor_amount $i" --save-program-output=yes;
    ((i=i*2));
    ((count++));
done
...
do
    ...
    ./run_test.sh --test-name="${compiler}_${nr}" --results-folder="$resultsRoot/memory_usage/sprite_actors" --command="./build/bin/nox_sprite_actors -actor_amount $i" --save-program-output=yes;
    ((i=i*2));
    ((count++));
done
...
do
    ...
    ./run_test.sh --test-name="${compiler}_deletes_01_empty_actors_${nr}" --results-folder="$resultsRoot/fast_spawning" --command="./build/bin/nox_fast_spawning -actor_name EmptyActor -actor_amount $i -deletion_amount 1" --save-program-output=yes;
    ./run_test.sh --test-name="${compiler}_deletes_10_empty_actors_${nr}" --results-folder="$resultsRoot/fast_spawning" --command="./build/bin/nox_fast_spawning -actor_name EmptyActor -actor_amount $i -deletion_amount 10" --save-program-output=yes;
    
    ./run_test.sh --test-name="${compiler}_deletes_01_sprite_actors_${nr}" --results-folder="$resultsRoot/fast_spawning" --command="./build/bin/nox_fast_spawning -actor_name SpriteActor -actor_amount $i -deletion_amount 1" --save-program-output=yes;
    ./run_test.sh --test-name="${compiler}_deletes_10_sprite_actors_${nr}" --results-folder="$resultsRoot/fast_spawning" --command="./build/bin/nox_fast_spawning -actor_name SpriteActor -actor_amount $i -deletion_amount 10" --save-program-output=yes;
    
    ./run_test.sh --test-name="${compiler}_deletes_01_transform_actors_${nr}" --results-folder="$resultsRoot/fast_spawning" --command="./build/bin/nox_fast_spawning -actor_name TransformActor -actor_amount $i -deletion_amount 1" --save-program-output=yes;
    ./run_test.sh --test-name="${compiler}_deletes_10_transform_actors_${nr}" --results-folder="$resultsRoot/fast_spawning" --command="./build/bin/nox_fast_spawning -actor_name TransformActor -actor_amount $i -deletion_amount 10" --save-program-output=yes;
...
do
    pushd $root > /dev/null 2>&1;
    ./compile.sh --cmake-arguments="-DNUC_TRIVIAL_COMPONENT_COUNT=${j}" --make-arguments="-j7";
    popd > /dev/null 2>&1;
    ...
    do
        ...
        ./run_test.sh --test-name="${compiler}_components_${j}_actors_${nr}" --results-folder="$resultsRoot/numerous_unique_components" --command="./build/bin/nox_numerous_unique_components -actor_amount $i -world_path world/${j}_world.json" --save-program-output=yes;

...
namespace nox
{
    namespace ecs
    {
        namespace operation
        {
             ...
             *
             * @warning    Casting to the correct component type is the users
             *             responsibility.
             */
             ...
             *             usually through a move construction or move
             *             assignment.
             *
             * @param      destination  The memory/component to move source
             *                          into.
            ...
            /**
             * @brief      Function used for initialization a component with a
             *             json value.
             *
            ...
            /**
             * @brief      Function to be called on events coming from the NOX
             *             event system.
             *
             * @param      first  pointer to the first element in the range.
             * @param      last   past-the-end pointer of the range.
             ...
             *             responsibility.
             */
            using EntityEventOp = void(*)(Component* first,
                                          Component* last,
